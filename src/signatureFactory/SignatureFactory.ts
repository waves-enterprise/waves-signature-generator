import {
  ...
  IDOCKERCALL_V3_PROPS,
  IDOCKERDISABLE_PROPS,
  IDOCKERUPDATE_V2_PROPS,
...
const DOCKER_CALL_V3 = generate<IDOCKERCALL_V3_PROPS>([
  constants.TRANSACTION_TYPE_NUMBER.DOCKER_CALL_V3,
  constants.TRANSACTION_TYPE_VERSION.DOCKER_CALL_V3,
  new Base58('senderPublicKey'),
  new Base58WithLength('contractId'),
  new DockerCreateParamsEntries('params'),
  new Long('fee'),
...
TX_NUMBER_MAP[constants.TRANSACTION_TYPE_NUMBER.DOCKER_CALL_V3] = DOCKER_CALL_V3
TX_TYPE_MAP[constants.TRANSACTION_TYPE.DOCKER_CALL_V3] = DOCKER_CALL_V3
...
const DOCKER_UPDATE_V2 = generate<IDOCKERUPDATE_V2_PROPS>([
  constants.TRANSACTION_TYPE_NUMBER.DOCKER_UPDATE_V2,
  constants.TRANSACTION_TYPE_VERSION.DOCKER_UPDATE_V2,
  new Base58('senderPublicKey'),
  new Base58WithLength('contractId'),
  new StringWithLength('image'),
  new StringWithLength('imageHash'),
...
TX_NUMBER_MAP[constants.TRANSACTION_TYPE_NUMBER.DOCKER_UPDATE_V2] = DOCKER_UPDATE_V2;
TX_TYPE_MAP[constants.TRANSACTION_TYPE.DOCKER_UPDATE_V2] = DOCKER_UPDATE_V2;
