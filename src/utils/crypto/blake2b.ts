...
const blake2bCompress = (ctx: Blake2bContext, last: boolean) => {
...
const blake2bInit = (outlen: number): Blake2bContext => {
...
const blake2bUpdate = (ctx: Blake2bContext, input: Uint8Array) => {
...
const blake2bFinal = (ctx: Blake2bContext) => {
...
export const blake2b = (input: Uint8Array, outlen = 64) => {
