...
import { KeyPairBytes } from '../../types'
...
const L = new Float64Array([
  0xed, 0xd3, 0xf5, 0x5c, 0x1a, 0x63, 0x12, 0x58, 0xd6,
...
function crypto_sign_direct(sm: Uint8Array, m: Uint8Array, n: number, sk: Uint8Array) {
...
function crypto_sign_direct_rnd(sm: Uint8Array, m: Uint8Array, n: number, sk: Uint8Array, rnd: Uint8Array) {
  const h = new Uint8Array(64)
  const r = new Uint8Array(64)
  const x = new Float64Array(64)
  const p = [gf(), gf(), gf(), gf()]
...
function curve25519_sign(sm: Uint8Array, m: Uint8Array, n: number, sk: Uint8Array, opt_rnd?: Uint8Array) {
...
function crypto_sign_open(m: Uint8Array, sm: Uint8Array, n: number, pk: Uint8Array) {
  let i; let mlen
  const t = new Uint8Array(32); const h = new Uint8Array(64)
  const p = [gf(), gf(), gf(), gf()]
  const q = [gf(), gf(), gf(), gf()]
...
// @ts-ignore
function checkArrayTypes(...args: any[]) { // eslint-disable-line @typescript-eslint/no-unused-vars
  let t; let i
...
export const sign = function (secretKey: Uint8Array, msg: Uint8Array, opt_random: Uint8Array) {
...
export const verify = function (publicKey: Uint8Array, msg: Uint8Array, signature: Uint8Array) {
...
export const generateKeyPair = function (seed: Uint8Array): KeyPairBytes {
  if (seed.length !== 32) {
